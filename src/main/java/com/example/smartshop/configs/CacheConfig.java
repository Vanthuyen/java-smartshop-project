...
public class CacheConfig implements CachingConfigurer {
    ...
    public CacheManager cacheManager(RedisConnectionFactory connectionFactory) {
        ...
        // Product detail cache - 15 minutes (ít thay đổi hơn)
        ...
        // Products list cache - 5 minutes (hay thay đổi hơn)
        ...
        // Product stock cache - 5 minutes
        cacheConfigurations.put("productStock", RedisCacheConfiguration.defaultCacheConfig()
                .entryTtl(Duration.ofMinutes(5))
                .disableCachingNullValues()
                .serializeKeysWith(RedisSerializationContext.SerializationPair
                        .fromSerializer(new StringRedisSerializer()))
